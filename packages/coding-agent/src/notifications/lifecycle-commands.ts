...
function firstLifecycleCommandToken(text: string | undefined): string | undefined {
...
export function isLifecycleCommandLikeText(text: string | undefined): boolean {
	const token = firstLifecycleCommandToken(text);
...
export function isLifecycleCommandText(
	...
	const rawCommand = firstLifecycleCommandToken(text);
